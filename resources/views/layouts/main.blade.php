...
<head>
      ...
      {{-- <meta name="description" content="This website develop"> --}}
      <meta name="author" content="Muhammad Nurdin">
      <title>VIDEO</title>
      <!-- Favicon Icon -->
   ...
   <body id="page-top" class="sidebar-toggled">
      <nav class="navbar navbar-expand navbar-light bg-white static-top osahan-nav sticky-top">
         ...
         <a class="navbar-brand mr-1" href="{{ url('/') }}"><img class="img-fluid" alt="" src="{{ asset('img/logo.png') }}"></a>
         <!-- Navbar Search -->
         ...
         <ul class="navbar-nav ml-auto ml-md-0 osahan-right-navbar">
            <li class="nav-item mx-1">
               <a class="nav-link" href="{{ url('upload-video') }}">
      ...
      <div id="wrapper">
         ...
         <ul class="sidebar navbar-nav toggled">
            ...
            <li class="nav-item {{ $active == 'Upload Video' ? 'active' : '' }}">
               <a class="nav-link " href="{{ url('upload-video') }}">
